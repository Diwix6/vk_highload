...
|---|---|---|---|---|
| Kubernetes workers | 10 | 2x AMD EPYC 9354P ($2200x2) + 16x 16GB DDR5 ECC RDIMM ($80x16) + 2x Samsung  PM9A3 3.84TB NVMe ($800x2) + корпус 2U ($600) + мат. плата SP3 ($1200) + 2x 1600W PSU ($400) | **$9 480** | **$94 800** |
| Cassandra nodes | 21 | 2x AMD EPYC 9354P ($2200x2) + 32x 8GB DDR5 ECC RDIMM ($50x32) + 6x Seagate Exos X20 HDD ($380x6) + 2x Samsung PM9A3 NVMe ($500x2) + 4U корпус ($800) + мат. плата ($1200) + 2x PSU ($500) | **$11 780** | **$247 380** |
| PostgreSQL global | 3 | 2x Intel Xeon Gold 6338 ($1800x2) + 8x 16GB DDR4 ECC ($50x8) + 2x WD Gold 22TB HDD ($400x2) + 1x Intel P5510 3.84TB NVMe ($800) + 2U корпус ($300) + мат. плата ($500) + 2x PSU ($200) | **$4 560** | **$37 020** |
| Redis nodes | 10 | Intel Xeon E-2388G ($600) + 4x 16GB DDR4 ECC ($60x4) + 2x Samsung 870 EVO 1.92TB ($200x2) + 1U корпус ($250) + мат. плата ($400) + PSU ($150) | **$2 040** | **$20 400** |
| Kafka brokers | 21 | AMD EPYC 7313P ($900) + 4x 16GB DDR4 ($60x4) + 4x Seagate Exos X16 HDD ($320x4) + 2U корпус ($400) + мат. плата ($600) + 2x PSU ($280) | **$3 700** | **$77 700** |
| NGINX L7 | 16 | Intel Xeon E-2388G ($600) + 4x 16GB DDR4 ($60x2) + Samsung PM893 480GB ($150) + 1U корпус ($250) + мат. плата ($400) + PSU ($150) | **$1 790** | **$28 640** |
| HAProxy L4 | 14 | Intel Xeon E-2388G ($600) + 4x 16GB DDR4 ($60x2) + Samsung PM893 480GB ($150) + 1U корпус ($250) + мат. плата ($400) + PSU ($150) | **$1 790** | **$25 060** |
| **Итого оборудование** | | | | **$531 000** |
 
**Дополнительные разовые затраты:**
- Сетевые коммутаторы (7 ДЦ x 2 шт x $3 000): **$42 000**
- Кабельная инфраструктура: **$15 000**
- Монтаж: **$20 000**
- **Итого разовые затраты: $608 000**
**Ежегодные операционные расходы (colocation + managed services):**
 
| Статья | Расчёт | /год |
|---|---|---|
| аренда стойко-мест | 7 ДЦ x 4 стойки x $800/стойка/мес x 12 | **$268 000** |
| Электроэнергия | ~200 серверов x 550 Вт x 8 760 ч x $0.10/кВтч | **$96 360** |
...
| **Своё железо** | $608 000 + $436 960 = $1 088 000 | $436 960 | $436 960 | $436 960 + $150 000 (обновление) | $436 960 | **$3 278 000** |
...
**Своё железо за 5 лет дороже на ~$793 000. Вывод однозначный — аренда выгоднее**
